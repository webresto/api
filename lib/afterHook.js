...
const controllerPaymentMethod_1 = require("@webresto/api/controllers/controllerPaymentMethod");
const controllerOrder_1 = require("@webresto/api/controllers/controllerOrder");
const controllerGetOrder_1 = require("@webresto/api/controllers/controllerGetOrder");
...
const controllerRestrictions_1 = require("@webresto/api/controllers/controllerRestrictions");
...
async function default_1() {
    try {
        ...
        hookTools_1.default.bindRouter(baseRoute + 'order/:orderNumber', controllerGetOrder_1.default, 'GET');
        hookTools_1.default.bindRouter(baseRoute + 'paymentmethods', controllerPaymentMethod_1.default, 'GET');
        hookTools_1.default.bindRouter(baseRoute + 'restrictions', controllerRestrictions_1.default, 'GET');
    }
    catch (e) {
